...
PROJECT_DIR = os.path.expanduser("~/code_before_paper/MyI10Tele")
XML_PATH = os.path.join(PROJECT_DIR, "assets/aubo_i10_inspire/myscene.xml")
TASK_NAME = "Put cube on the black platform"

AUBOI10_QPOS_ROOT = "~/code_before_paper/MyI10Tele/data_auboI10_v2"
AUBOI10_EEPOSE_ROOT = "~/code_before_paper/MyI10Tele/data_auboI10_ee_pose"
