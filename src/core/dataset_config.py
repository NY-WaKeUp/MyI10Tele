...
REPO_NAME = "auboI10"
# "qpos": commanded joint targets after IK (OpenPI-style; matches MyEnv.step q_target).
# "ee_pose": commanded absolute flange xyz+rpy+gripper (observation.state stays qpos).
ACTION_LABEL = "temp"  # or "ee_pose" "qpos" or "temp"
...
AUBOI10_EEPOSE_ROOT_V30_CORRECTOBJINIT = (
